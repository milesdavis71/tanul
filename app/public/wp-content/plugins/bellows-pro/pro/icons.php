...
function bellows_register_icons( $group , $iconmap ){
	_BELLOWS()->register_icons( $group, $iconmap );
}

function bellows_deregister_icons( $group ){
	_BELLOWS()->deregister_icons( $group );
}
function bellows_get_registered_icons(){
	return _BELLOWS()->get_registered_icons();
}
function bellows_get_icon_ops(){

	$icons = bellows_get_registered_icons();
...
function bellows_register_default_icons(){

	bellows_register_icons( 'font-awesome' , array(
		'title' => 'Font Awesome',
		'class_prefix' => 'fa ',
		'iconmap' => bellows_get_icons() 
	));

}

function bellows_get_icons(){
