...
class Nav_Menu extends Base{
	...
	public function get_keywords () {
		return [ 'menu', 'nav-menu', 'nav', 'navigation', 'navigation-menu' ];
    }
    ...
    protected function __menu_wrapper_style_controls () {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ha-menu-container'   => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'devices' => ['tablet'],
                'selectors' => [
                    '{{WRAPPER}} .ha-nav-identity-panel' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ha-menu-container' => 'max-width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .ha-menu-offcanvas-elements' => '--offcanvas-left-offset: -{{SIZE}}{{UNIT}};'
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'ha_menu_item_icon_spacing',
            [
                'label' => esc_html__( 'Menu Icon Spacing', 'happy-addons-pro' ),
                'description' => esc_html__( 'This is only work with Mega menu icon option', 'happy-addons-pro' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .ha-navbar-nav li a .ha-menu-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function __submenu_item_style_controls () {
        ...
        $this->add_control(
            'ha_sub_menu_item_indicator_heading',
            [
                'label' => esc_html__( 'Indicator', 'happy-addons-pro' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'ha_style_tab_submenu_item_arrow',
            [
                'label' => esc_html__( 'Type', 'happy-addons-pro' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'ha_line_arrow',
                'options' => [
                    'ha_line_arrow'  => esc_html__( 'Line Arrow', 'happy-addons-pro' ),
                    'ha_plus_icon' => esc_html__( 'Plus', 'happy-addons-pro' ),
                    'ha_fill_arrow' => esc_html__( 'Fill Arrow', 'happy-addons-pro' ),
                    'ha_none' => esc_html__( 'None', 'happy-addons-pro' ),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' =>  '#000000',
                'selectors' => [
                    '{{WRAPPER}} .ha-navbar-nav > li > a .ha-submenu-indicator' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'ha_style_tab_submenu_item_arrow!' => 'ha_none'
                ]
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .ha-navbar-nav-default .ha-dropdown-has>a .ha-submenu-indicator' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'ha_style_tab_submenu_item_arrow!' => 'ha_none'
                ]
    ...
    protected function __hamburger_style_controls () {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ha-menu-hamburger' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render_raw( ) {
        ...
        if($settings['nav_menu'] != '' && wp_get_nav_menu_items($settings['nav_menu']) !== false && count(wp_get_nav_menu_items($settings['nav_menu'])) > 0){
            ...
            $args = [
                ...
                'container_class' => 'ha-menu-container ha-menu-offcanvas-elements ha-navbar-nav-default ' . $settings['ha_style_tab_submenu_item_arrow'] . ' ha-nav-menu-one-page-' . $settings['one_page_enable'],
                'menu_id'         => 'main-menu',
