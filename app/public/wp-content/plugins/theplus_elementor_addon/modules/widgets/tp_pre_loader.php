    ...
    protected function _register_controls() {		
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em'],				
				'selectors' => [
					'.tp-loader-wrapper #tp-loader .tp-preloader-icon i' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em'],				
				'selectors' => [
					'.tp-loader-wrapper #tp-loader .tp-preloader-icon i' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'after',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '.tp-loader-wrapper #tp-loader .tp-preloader-icon i',
			]
		);
		$this->add_group_control(
			Group_Control_Border::get_type(),
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'.tp-loader-wrapper #tp-loader .tp-preloader-icon i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',				
				],	
			]
		);
		$this->add_group_control(
