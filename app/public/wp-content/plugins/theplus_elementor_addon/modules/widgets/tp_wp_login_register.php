							...
							<div class="elementor-form-fields-wrapper tp-popup-body">
								<?php if ($settings['modal_header']=='yes') : ?>
									<div class="tp-popup-header">												
										<h2 class="tp-popup-title"><span tp-icon="user"></span> <?php echo esc_html( $settings['modal_header_description_log'] ); ?></h2>
									</div>
								<?php endif; ?>
								<?php $this->user_login_form(); ?>
							</div>
				  ...
				  <div class="tp-modal">						
					...
					<div class="tp-ursp-content">
						<div class="elementor-form-fields-wrapper tp-popup-body">
							<?php if ($settings['modal_header']=='yes') : ?>
								<div class="tp-popup-header">
									<h2 class="tp-popup-title"><span tp-icon="user"></span> <?php echo esc_html( $settings['modal_header_description_reg'] ); ?></h2>
								</div>
							<?php endif; ?>
							<?php $this->user_register_form(); ?>
						</div>
