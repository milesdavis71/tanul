...
class ThePlus_Advertisement_Banner extends Widget_Base {
	...
	protected function render_text() {	
		...
		if($button_style=='style-1'){
			$button_text =wp_kses_post($icons_before).esc_html($button_text) . wp_kses_post($icons_after);
		...
		if($button_style=='style-11'){
			$button_text ='<span>'.wp_kses_post($icons_before) . esc_html($button_text) . wp_kses_post($icons_after).'</span>';
		}
		...
		if($button_style=='style-18' || $button_style=='style-19' || $button_style=='style-20' || $button_style=='style-21' || $button_style=='style-22'){
			$button_text =wp_kses_post($icons_before) .'<span>'. esc_html($button_text) .'</span>'. wp_kses_post($icons_after);
		}
