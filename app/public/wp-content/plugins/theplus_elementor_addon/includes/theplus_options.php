...
class Theplus_Elementor_Plugin_Options
{
    ...
    public function __construct()
    {
		...
		//Extar Options
		remove_action( 'theplus_free_pro_api_connection_data', 'theplus_free_api_connection_data_content' );		
	...
	$plus_key = isset($purchase_option['tp_api_key']) ? $purchase_option['tp_api_key'] : '';
	$cls_close='';
	if($verify_api==1 && !empty($plus_key)){		
		$cls_close = ' tp-close-up-box';
	} ?>
